...
function blog_lite_setup() {
     ...
     * If you're building a theme based on Blog Lite, use a find and replace
     * to change 'blog-lite' to the name of your theme in all the template files.
     */
    load_theme_textdomain( 'blog-lite', get_template_directory() . '/languages' );
...
function blog_lite_scripts() {	
    ...
    wp_enqueue_style( 'blog-lite-grid', get_template_directory_uri() . '/assets/css/grid.css' );
	...
	wp_enqueue_script( 'blog-lite-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array('jquery'), '20151215', true );

    wp_enqueue_script( 'blog-lite-keyboard-navigation', get_template_directory_uri() . '/assets/js/keyboard-navigation.js', array('jquery'), '20151215', true );
