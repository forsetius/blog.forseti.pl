    ...
    if( 1 === $theme_options['slider_enable'] ){ 
      ...
      if( 'slider' === $theme_options['main_slider_type'] ){ 
        ...
        if(!empty( $theme_options['slider_cat'] )){
          $slider_args = array( 'cat' => absint($theme_options['slider_cat']), 'post_status' => 'publish', 'posts_per_page' => 5 );
        } else{
          $slider_args = array('tag' => 'wazne', 'post_status' => 'publish', 'posts_per_page' => 5 );
        }
