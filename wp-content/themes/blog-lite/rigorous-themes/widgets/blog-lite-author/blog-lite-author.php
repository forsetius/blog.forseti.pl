...
function blog_lite_author_scripts( $hook ) {
	...
	wp_enqueue_style( 'blog-lite-about-me-admin', get_template_directory_uri() . '/rigorous-themes/widgets/blog-lite-author/css/admin' . $min . '.css', array(), '1.0.0' );

	wp_enqueue_media();

	wp_enqueue_script( 'blog-lite-about-me-admin', get_template_directory_uri() . '/rigorous-themes/widgets/blog-lite-author/js/admin' . $min . '.js', array( 'jquery' ), '1.0.0' );
