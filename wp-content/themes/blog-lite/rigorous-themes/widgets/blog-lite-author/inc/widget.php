...
class Blog_Lite_Author extends WP_Widget {
	...
	function __construct() {
		...
		$opts = array(
			...
			'description'                 => esc_html__( 'A widget that displays author bio with description, cover and profile picture.', 'blog-lite' ),
			'customize_selective_refresh' => true,
		);

		parent::__construct( 'blog-lite', esc_html__( 'Blog Pro: Author Bio', 'blog-lite' ), $opts );
		...
		echo '<div class="widget-about-me">';	?>
					...
					<div class="headshot-wrapper"> 
						...
						if ( ! empty( $rtam_cover_pic ) ) {			
							...
							$alt_text_c =  esc_html__('cover-photo', 'blog-lite');
						...
						if ( ! empty( $rtam_profile_pic ) ) {
							...
							$alt_text_p =  esc_html__('profile-photo', 'blog-lite');
	...
	function form( $instance ) {
		...
		<div class="cover-image">
			...
			<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'blog-lite' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Cover Photo', 'blog-lite' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'blog-lite' ); ?>" style="margin-top:5px;" />
			...
			<div class="rtam-preview-wrap" <?php echo $wrap_style; ?>>
				<img src="<?php echo esc_url( $rtam_cover_pic ); ?>" alt="<?php esc_attr_e( 'Preview', 'blog-lite' ); ?>" style="max-width: 100%;"  />
	    ...
	    <div class="profile-image">
			...
			<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'blog-lite' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Profile Photo', 'blog-lite' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'blog-lite' ); ?>" style="margin-top:5px;" />
			...
			?>
			<div class="rtam-preview-wrap" <?php echo $wrap_style; ?>>
				<img src="<?php echo esc_url( $rtam_profile_pic ); ?>" alt="<?php esc_attr_e( 'Preview', 'blog-lite' ); ?>" style="max-width: 100%;"  />
			</div><!-- .rtam-preview-wrap -->
		...
		<p>
		    <label for="<?php echo esc_attr( $this->get_field_id( 'rtam_intro_title' ) ); ?>">
		    	<?php esc_html_e( 'Intro Title', 'blog-lite' ); ?>:
		    </label>
		...
		<p>
		  <label for="<?php echo esc_attr( $this->get_field_id( 'rtam_short_bio' ) ); ?>">
		  	<?php esc_html_e( 'Short Bio', 'blog-lite' ); ?>:
		  </label>
	    ...
	    <p>
	      <label for="<?php echo esc_attr( $this->get_field_id( 'rtam_link' ) ); ?>"><?php esc_html_e( 'Link', 'blog-lite' ); ?>:</label>
	    ...
	    <p>
	    	<input id="<?php echo esc_attr( $this->get_field_id( 'rtam_open_link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'rtam_open_link' ) ); ?>" type="checkbox" <?php checked( isset( $instance['rtam_open_link'] ) ? $instance['rtam_open_link'] : 0 ); ?> />
	      	<label for="<?php echo esc_attr( $this->get_field_id( 'rtam_open_link' ) ); ?>"><?php esc_html_e( 'Open in New Tab', 'blog-lite' ); ?></label>
	    </p>
	    ...
	    <p>
	    	<input id="<?php echo esc_attr( $this->get_field_id( 'rtam_disable_link_in_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'rtam_disable_link_in_title' ) ); ?>" type="checkbox" <?php checked( isset( $instance['rtam_disable_link_in_title'] ) ? $instance['rtam_disable_link_in_title'] : 0 ); ?> />
	      	<label for="<?php echo esc_attr( $this->get_field_id( 'rtam_disable_link_in_title' ) ); ?>"><?php esc_html_e( 'Disable Link in Title', 'blog-lite' ); ?></label>
	    </p>
	    ...
	    <p>
	    	<input id="<?php echo esc_attr( $this->get_field_id( 'rtam_disable_link_in_pic' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'rtam_disable_link_in_pic' ) ); ?>" type="checkbox" <?php checked( isset( $instance['rtam_disable_link_in_pic'] ) ? $instance['rtam_disable_link_in_pic'] : 0 ); ?> />
	      	<label for="<?php echo esc_attr( $this->get_field_id( 'rtam_disable_link_in_pic' ) ); ?>"><?php esc_html_e( 'Disable Link in Profile Picture', 'blog-lite' ); ?></label>
	    </p>
